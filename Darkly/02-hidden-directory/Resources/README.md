...
2- README
	...
	c2r7s5% grep -R "flag" 10.12.200.238/.hidden 
...
then
find <IP>/.hidden -name README -exec cat {} \; or save in a file -> find <IP>.hidden -name README -exec cat {} \; > readmes.txt

search for something different or - grep -i flag readmes.txt
